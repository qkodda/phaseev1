...
CREATE TABLE IF NOT EXISTS ideas (
    ...
    method TEXT, -- 'random' or 'custom'
    status TEXT DEFAULT 'pinned', -- 'pinned' or 'scheduled'
    scheduled_date DATE,
    created_at TIMESTAMPTZ DEFAULT NOW(),
    updated_at TIMESTAMPTZ DEFAULT NOW()
);
...
CREATE TABLE IF NOT EXISTS generation_analytics (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    user_id UUID REFERENCES auth.users(id) ON DELETE CASCADE NOT NULL,
    event_type TEXT NOT NULL, -- 'generated', 'pinned', 'scheduled'
...
CREATE TABLE IF NOT EXISTS app_analytics (
    ...
    event_type TEXT NOT NULL, -- 'page_view', 'session_start', 'session_end', 'error'
    page_name TEXT,
...
BEGIN
    ...
    RAISE NOTICE '📊 Tables: profiles, ideas, generation_analytics, app_analytics, feedback';
